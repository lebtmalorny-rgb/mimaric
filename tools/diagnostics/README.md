...
- [collect-v2.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/tools/diagnostics/collect-v2.yml) — вся цепочка PowerOps; описание ниже.
- [collect-mistral.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/tools/diagnostics/collect-mistral.yml) — Mistral API, 504, executions,
