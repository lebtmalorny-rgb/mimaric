...
| Универсальный сбор PowerOps | [collect-v2.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/fb038268deb25911d955c4c2e3f28dd89383bc45/tools/diagnostics/collect-v2.yml) |
| Медленный Mistral, 504, зависшие executions | [collect-mistral.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/fb038268deb25911d955c4c2e3f28dd89383bc45/tools/diagnostics/collect-mistral.yml) |
...
- [ADR-0002: firewall хостов Kolla-Ansible](../../docs/adr/0002-host-firewall.md) —
  ...
  сохранением SSH, предварительным отчётом и откатом. Реализованы
  [команда Kolla-Ansible, отчёт, применение и откат](../../integrations/kolla-ansible/host-firewall/README.md).
  Каталог связей пока частичный и блокирует применение ограничений для
  полноценного OpenStack; проверки на стенде не выполнены.

## База и порядок применения

1. Использовать именно три пользовательских архива `0809`, перечисленных с SHA256
   в [baselines/0809.json](https://github.com/lebtmalorny-rgb/mimaric/blob/fb038268deb25911d955c4c2e3f28dd89383bc45/baselines/0809.json). Архивы содержат исходники для
