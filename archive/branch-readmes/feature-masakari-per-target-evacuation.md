...
| Универсальный сбор PowerOps | [collect-v2.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/tools/diagnostics/collect-v2.yml) |
| Медленный Mistral, 504, зависшие executions | [collect-mistral.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/tools/diagnostics/collect-mistral.yml) |
| Masakari: Nova down после fencing | [Патч и порядок применения](../../hotfixes/masakari-post-fence-nova-down/README.md) |
| Аварийная блокировка периодической автоматизации Watcher | [Комплект и runbook](../../docs/WATCHER-AUTOMATION-HOLD.md) |
...
Новая отдельная очередь эвакуаций на принимающих compute:
[Masakari per-target evacuation](../../docs/MASAKARI-PER-TARGET-EVACUATION.md).
По умолчанию выключена; поставка включает три серии и локальный wheel,
накладывается после неизменного Watcher-комплекта по точным базам manifest.

1. Использовать именно три пользовательских архива `0809`, перечисленных с SHA256
   в [baselines/0809.json](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/baselines/0809.json). Архивы содержат исходники для
