...
| Универсальный сбор PowerOps | [collect-v2.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/16227bfc6b43decd39a14b62c2ea8a697b914ae5/tools/diagnostics/collect-v2.yml) |
| Медленный Mistral, 504, зависшие executions | [collect-mistral.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/16227bfc6b43decd39a14b62c2ea8a697b914ae5/tools/diagnostics/collect-mistral.yml) |
| Host firewall: read-only обследование и предварительная матрица | [Добавка к Kolla-Ansible](../versions/feature-host-firewall-report/integrations/kolla-ansible/host-firewall/README.md) |
...
- [ADR-0002: firewall хостов Kolla-Ansible](../versions/feature-host-firewall-report/docs/adr/0002-host-firewall.md) —
  ...
  [report-only этап](../versions/feature-host-firewall-report/integrations/kolla-ansible/host-firewall/README.md):
...
1. Использовать именно три пользовательских архива `0809`, перечисленных с SHA256
   в [baselines/0809.json](https://github.com/lebtmalorny-rgb/mimaric/blob/16227bfc6b43decd39a14b62c2ea8a697b914ae5/baselines/0809.json). Архивы содержат исходники для
