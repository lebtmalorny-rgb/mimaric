...
[проверка планового выключения с миграцией](AUDIT-2026-09-09-planned-off-live-migration.md).
Он включён в единый комплект `main` вместе с семью основными документами.
...
Дополнительный патч Masakari находится в репозитории `mimaric`, ветка
`main`, каталог
