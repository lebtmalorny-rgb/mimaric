...
| Диагностический сборщик | `tools/diagnostics/collect-v2.yml`; исходник встроенного сборщика: `tools/diagnostics/files/collect.py` |
...
[collect-v2.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/tools/diagnostics/collect-v2.yml).
В едином комплекте используется только имя `collect-v2.yml`. Плейбук содержит inventory
...
`tools/diagnostics/tests/test_real_cli.py`. Они включены в единый комплект main.
Для запуска используется самостоятельный
[collect-v2.yml](https://github.com/lebtmalorny-rgb/mimaric/blob/71b0123f390bfeaab4dc4ca2dffaa6fab32a6cdf/tools/diagnostics/collect-v2.yml), уже присутствующий в `main`.
